...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white selection:bg-red-500/30 overflow-x-hidden flex flex-col">
        ...
        {!selectedVideo ? (
          ...
          >
            ...
            <div className="flex pt-14 flex-1">
              <Sidebar />
              <main className="flex-1 lg:ml-60 px-0 sm:px-4 pb-20 lg:pb-0">
                {renderContent()}
              </main>
            </div>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-[#0f0f0f] overflow-y-auto no-scrollbar pb-safe flex flex-col"
          >
            <div className="sticky top-0 bg-[#0f0f0f]/90 backdrop-blur-md z-50 flex items-center h-14 px-4 border-b border-white/5 shrink-0">
              <button 
                onClick={handleBack}
              ...
              <div className="max-w-[1280px] mx-auto">
                <div className="flex flex-col lg:flex-row gap-6 pt-0 sm:pt-4">
                  ...
                  <div className="lg:w-[400px] flex flex-col gap-4 px-4 lg:px-0 pb-20">
                    <h3 className="font-bold text-lg mt-4 lg:mt-0 tracking-tight">Recommended for you</h3>
